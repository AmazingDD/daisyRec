...
|val_method<br>test_method | train-validation splitting;<br>train-test splitting |fo<br>tfo<br>loo<br>tloo<br>cv   |split-by-ratio<br>time-aware split-by-ratio<br>leave one out<br>time-aware leave one out<br>cross validation (only apply to val_method) |
