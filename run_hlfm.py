...
@LastEditors: Yudi
@LastEditTime: 2019-12-09 18:05:17
...
from daisy.model.pairwise.HLFMRecommender import HLFM
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Hinge loss FM recommender test')
    # common settings
    ...
    for fold in range(fn):
        ...
        model = HLFM(num_features, args.hidden_factor, args.batch_norm, eval(args.dropout), 
