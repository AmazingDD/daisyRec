...
@LastEditors: Yudi
@LastEditTime: 2019-12-09 16:17:24
...
from daisy.model.pairwise.HLMFRecommender import HLMF
from daisy.utils.loader import load_rate, split_test, split_validation, get_ur, PairMFData
from daisy.utils.metrics import precision_at_k, recall_at_k, map_at_k, hr_at_k, mrr_at_k, ndcg_at_k

if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Hinge Loss-MF recommender test')
    # common settings
