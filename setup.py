...
setup(
    ...
    version='v2.0.8',  # Ideally should be same as your GitHub release tag varsion
    ...
    download_url='https://github.com/AmazingDD/daisyRec/archive/refs/tags/v2.0.8.tar.gz',
