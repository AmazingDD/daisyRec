...
if __name__ == '__main__':
    ...
    parameter 
    '''
    parser = argparse.ArgumentParser(description='test recommender test')
    # common settings
    parser.add_argument('--algo_base', type=str, default='mostpop', help='algorithm to choose')
    ...
    parser.add_argument('--mix_sample_method', 
                        type=str, 
                        default='', 
