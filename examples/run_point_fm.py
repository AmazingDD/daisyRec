...
@LastEditors  : Yudi
@LastEditTime : 2020-01-04 14:23:43
...
if __name__ == '__main__':
    ...
    train_sampled = negative_sampling(user_num, item_num, train_set, args.num_ng, 0.)
    ...
    res.to_csv(f'{result_save_path}{args.prepro}_{args.test_method}_pointfm_{args.loss_type}.csv', 
               index=False)
    print('='* 20, ' Done ', '='*20)
