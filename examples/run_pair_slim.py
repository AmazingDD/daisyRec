...
@LastEditors  : Yudi
@LastEditTime : 2019-12-31 14:47:49
...
if __name__ == '__main__':
    ...
    # build recommender model
    model = PairSLiM(train_set, user_num, item_num, args.epochs, 
    ...
    res.to_csv(f'{result_save_path}{args.prepro}_{args.test_method}_pairslim_{args.loss_type}.csv', 
               index=False)
    print('='* 20, ' Done ', '='*20)
