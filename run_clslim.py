...
@LastEditors: Yudi
@LastEditTime: 2019-12-11 09:37:21
...
from daisy.model.pointwise.CLSLiMRecommender import CLSLiM
from daisy.utils.loader import load_rate, split_test, split_validation, get_ur, PointMFData
from daisy.utils.metrics import precision_at_k, recall_at_k, map_at_k, hr_at_k, mrr_at_k, ndcg_at_k

if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Cross-Entropy SLiM recommender test')
    # common settings
    ...
    for fold in range(fn):
        ...
        model = CLSLiM(train, user_num, item_num, args.epochs, 
