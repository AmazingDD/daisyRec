...
@LastEditors: Yudi
@LastEditTime: 2019-12-11 10:02:34
...
from daisy.model.pairwise.BPRSLiMRecommender import BPRSLiM
from daisy.utils.loader import load_rate, split_test, split_validation, get_ur, PairMFData
from daisy.utils.metrics import precision_at_k, recall_at_k, map_at_k, hr_at_k, mrr_at_k, ndcg_at_k

if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='BPR SLiM recommender test')
    # common settings
    ...
    for fold in range(fn):
        ...
        model = BPRSLiM(train, user_num, item_num, args.epochs, 
