...
def opt_func(params):
    window, e_dim, n_negs = params['window'], params['e_dim'], params['n_negs']
    print(f'Parameter Settings: window size:{window}, e_dim:{e_dim}, n_negs:{n_negs}')
    ...
    line = ','.join(fnl_metric) + f',{window},{e_dim},{n_negs}' + '\n'
